# Graph Report - BootHub  (2026-07-27)

## Corpus Check
- 75 files · ~115,655 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 792 nodes · 1411 edges · 69 communities (63 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4c4032f3`
...
4. `TuiText()` - 31 edges
5. `processSyncQueue()` - 31 edges
6. `Fallow CLI Reference` - 30 edges
7. `ensureFileUri()` - 24 edges
8. `Common Workflows` - 22 edges
...
- `MainApp()` --calls--> `useTheme()`  [EXTRACTED]
  App.tsx → src/theme/theme-provider.tsx
- `MainApp()` --calls--> `useBottomBarAnimation()`  [EXTRACTED]
  App.tsx → src/hooks/use-bottom-bar-animation.ts
- `MainApp()` --calls--> `useDeepLink()`  [EXTRACTED]
  App.tsx → src/hooks/use-deep-link.ts
- `MainApp()` --calls--> `useEditItem()`  [EXTRACTED]
  App.tsx → src/hooks/use-edit-item.ts
...
Cohesion: 0.05
Nodes (43): backgroundColor, backgroundImage, foregroundImage, monochromeImage, adaptiveIcon, permissions, predictiveBackGestureEnabled, experimental (+35 more)

### Community 2 - "Community 2"
Cohesion: 0.08
Nodes (64): styles, TuiButton(), TuiButtonProps, SettingsScreen(), SettingsScreenProps, styles, formatSyncTimestamp(), addItem() (+56 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (38): dependencies, axios, expo, expo-auth-session, expo-clipboard, expo-crypto, expo-dev-client, expo-document-picker (+30 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (27): author, devDependencies, eslint, @eslint/js, eslint-plugin-react-hooks, eslint-plugin-react-refresh, globals, prettier (+19 more)
...
Cohesion: 0.50
Nodes (3): useBottomBarAnimation(), UseBottomBarAnimationOptions, UseBottomBarAnimationReturn
...
Cohesion: 0.14
Nodes (24): BaseFolderScreenProps, FolderItemProps, FolderScreenProps, FolderHeader(), FolderHeaderProps, styles, FolderItem(), FolderItemProps (+16 more)
...
Cohesion: 0.17
Nodes (16): BaseFolderScreen(), ChartItem, MeterSegment, styles, TuiBarChart(), TuiBarChartProps, TuiProgressMeter(), TuiProgressMeterProps (+8 more)
...
Cohesion: 0.08
Nodes (26): MONTHS, styles, TuiCalendar(), TuiCalendarProps, WEEKDAYS, styles, TuiCheckbox(), TuiCheckboxProps (+18 more)

### Community 31 - "Community 31"
Cohesion: 0.19
Nodes (14): ContextMenuOverlay(), ContextMenuOverlayProps, styles, LinkPreview(), PreviewData, ShareImportSheet(), styles, { width: screenWidth } (+6 more)
...
Cohesion: 0.27
Nodes (12): ContextMenuOverlay(), handleCopyItem(), base64ToBytes(), bytesToBase64(), ensureFileUri(), extractAudioArtwork(), getActualType(), getWebsiteName() (+4 more)
...
Cohesion: 0.17
Nodes (12): EmptyFolderPlaceholder(), styles, calculateFullscreenImageBounds(), FullscreenPhotoViewer(), FullscreenPhotoViewerProps, styles, AnimatedPressable, PhotoItem() (+4 more)
...
Cohesion: 0.15
Nodes (11): MainApp(), AnimationLockContext, AnimationLockContextValue, AnimationLockProvider(), useAnimationLock(), useAppData(), useHeaderMenu(), UseHeaderMenuOptions (+3 more)
...
Cohesion: 0.33
Nodes (7): ShareImportSheetProps, useDeepLink(), UseDeepLinkOptions, getUniqueDestinationUri(), ParsedShare, parseShareUrl(), processSharedItem()
...
Cohesion: 0.08
Nodes (28): BottomBar(), BottomBarProps, EditModeBarProps, NormalInputBarProps, SelectionModeBarProps, styles, FolderPickerSheetProps, decodeHtmlEntities() (+20 more)
...
Cohesion: 0.47
Nodes (8): ensureFoldersExist(), initFilesystemSync(), migrateLegacyFiles(), resolveFolderPath(), sanitizeFilename(), syncDatabaseTextsAndLinks(), syncDatabaseToFilesystem(), tabToFolderName()
...
- **Why does `useTheme()` connect `Community 27` to `Community 0`, `Community 2`, `Community 35`, `Community 38`, `Community 43`, `Community 21`, `Community 22`, `Community 23`, `Community 54`, `Community 28`, `Community 30`, `Community 31`?**
...
- **Why does `Fallow CLI Reference` connect `Community 24` to `Community 64`, `Community 33`, `Community 66`, `Community 65`, `Community 36`, `Community 37`, `Community 39`, `Community 40`, `Community 46`, `Community 55`, `Community 56`, `Community 57`, `Community 58`, `Community 59`, `Community 60`, `Community 61`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `DumpItem` connect `Community 21` to `Community 0`, `Community 2`, `Community 35`, `Community 38`, `Community 49`, `Community 54`, `Community 28`, `Community 31`?**
