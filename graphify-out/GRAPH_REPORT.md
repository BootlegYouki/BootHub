...
## Corpus Check
- 52 files · ~82,454 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 433 nodes · 897 edges · 33 communities (30 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `603bea8f`
...
- `MainApp()` --calls--> `useTheme()`  [EXTRACTED]
  App.tsx → src/theme/theme-provider.tsx
- `ContextMenuOverlay()` --calls--> `ensureFileUri()`  [EXTRACTED]
  App.tsx → src/utils/helpers.ts
...
Cohesion: 0.09
Nodes (11): ContextMenuOverlayProps, DumpItem, DumpType, mockItems, styles, TabButtonProps, BannerSvg(), IconSvg() (+3 more)
...
Cohesion: 0.07
Nodes (60): ContextMenuOverlay(), ContextMenuOverlayProps, styles, EmptyFolderPlaceholder(), styles, FolderHeader(), FolderHeaderProps, styles (+52 more)
...
Cohesion: 0.17
Nodes (14): ContextMenuOverlay(), TabButton(), ShareImportSheet(), SPRING_CONFIG_OPEN, styles, TuiDrawer(), TuiDrawerProps, FilesScreen() (+6 more)
...
Cohesion: 0.39
Nodes (7): decodeHtmlEntities(), extractMetaTags(), getStorageKeyForUrl(), isDirectImageUrl(), LinkPreviewProps, preFetchLinkMetadata(), styles

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (67): SettingsScreen(), SettingsScreenProps, styles, clearAuthSession(), deleteFileFromDrive(), discovery, downloadJsonContent(), DriveUploadResponse (+59 more)
...
Cohesion: 0.18
Nodes (9): styles, TuiSkeletonLoader(), ACCENT_COLORS, AccentTheme, ThemeColors, ThemeContext, ThemeContextType, ThemeMode (+1 more)
...
Cohesion: 0.20
Nodes (10): FolderPickerSheet(), FolderPickerSheetProps, { height: screenHeight }, styles, styles, TuiInput(), TuiInputProps, DumpType (+2 more)
...
- **Why does `useTheme()` connect `Community 5` to `Community 0`, `Community 2`, `Community 7`, `Community 8`, `Community 15`, `Community 19`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `DumpItem` connect `Community 2` to `Community 0`, `Community 8`, `Community 23`?**
