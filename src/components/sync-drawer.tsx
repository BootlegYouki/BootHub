...
import { View, StyleSheet, Alert, TextInput, Pressable, Platform, Animated as RNAnimated } from 'react-native';
...
export const SyncDrawer: React.FC<SyncDrawerProps> = ({ visible, onClose }) => {
  ...
  const submitPairingCode = async () => {
    ...
    try {
      ...
      targetUrls.push('http://10.0.2.2:14201/pair');
